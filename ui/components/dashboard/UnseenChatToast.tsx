...
const UnseenChatToast: FC<UnseenChatToastProps> = ({
  ...
  return (
    <div
      className={cn(
        'max-w-md w-full bg-white shadow-lg rounded-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5 text-black',
      ...
      <a
        ...
        <div className='flex items-center'>
          ...
          <div className='ml-3 flex-1'>
            <p className='text-large font-bold'>{senderName}</p>
